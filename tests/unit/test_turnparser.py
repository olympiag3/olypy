...
def test_fake_order():
    tests = [[['move e', '3', '10', '2', '10002', '1000'], {'CHmo': 70,
                                                            'ar': ['0', '0', '10002', '0', '0', '23', '1001', '0'],
                                                            'cs': ['2'],
                                                            'de': ['21'],
                                                            'li': ['move e'],
                                                            'pr': ['3'],
                                                            'st': ['1'],
                                                            'wa': ['2']}],
             [['sail e', '3', '10', '2', '10002', '1000'], {'ar': ['0', '0', '10002', '0', '0', '23', '10001', '0'],
                                                            'cs': ['2'],
                                                            'de': ['21'],
                                                            'li': ['sail e'],
                                                            'pr': ['4'],
                                                            'st': ['1'],
                                                            'wa': ['2']}],
             [['collect 10 0 0', '3', '29', '-1', 'x', 'x'], {'ar': ['10', '0', '0', '2', '0', '0', '0', '0'],
                                                              'cs': ['2'],
                                                              'de': ['2'],
                                                              'li': ['collect 10 0 0'],
                                                              'po': ['1'],
                                                              ...
                                                              'st': ['1'],
                                                              'wa': ['-1']}],
             [['use 823 832', '3', '29', '12', 'x', 'x'], {'ar': ['832', '0', '0', '0', '0', '0', '0', '823'],
                                                           'cs': ['2'],
                                                           'de': ['2'],
                                                           'li': ['use 823 832'],
                                                           'pr': ['3'],
...
def test_parse_routes_leaving():
    ...
    data = {}
    turnparser.make_locations_from_routes(r, '10101', 'forest', 'Camaris', '50033', data)
...
'''
    ret = {'1001': {'LI': {'hl': ['6940', '1771', '2370', '3622']}},
           '1771': {'CH': {'at': ['60'], 'df': ['60'], 'he': ['100']},
                    'LI': {'hl': ['2480'], 'wh': ['1001'], 'hl': ['2480']},
                    'firstline': ['1771 char 0'],
                    'il': ['10', '19'],
                    'na': ['Woodrow Call']},
           '2259': {'CH': {'at': ['60'], 'df': ['60'], 'he': ['100']},
                    'LI': {'hl': ['3984'], 'wh': ['3622'], 'hl': ['3984']},
                    'firstline': ['2259 char 0'],
                    'il': ['11', '20'],
                    'na': ['Yoyo 2']},
           '2370': {'CH': {'at': ['60'], 'df': ['60'], 'he': ['100']},
                    'LI': {'wh': ['1001']},
                    'firstline': ['2370 char 0'],
                    'il': ['10', '15', '11', '5'],
                    'na': ['Eric']},
           '2480': {'CH': {'at': ['60'], 'df': ['60'], 'he': ['100']},
                    'LI': {'wh': ['1771']},
                    'firstline': ['2480 char 0'],
                    'il': ['10', '2'],
                    'na': ['Pea Eye Parker']},
           '3622': {'LI': {'hl': ['2259'], 'wh': ['1001'], 'hl': ['2259']},
                    'SL': {'bm': ['3'], 'ca': ['25000'], 'eg': ['23000'], 'er': ['50000']},
                    'firstline': ['3622 ship roundship-in-progress'],
                    'na': ['Tub 1']},
           '3984': {'CH': {'at': ['60'], 'df': ['60'], 'he': ['100']},
                    'LI': {'wh': ['2259']},
                    'firstline': ['3984 char 0'],
                    'il': ['10', '2', '19', '6'],
                    'na': ['Yoyo 5']},
           '6940': {'CH': {'at': ['60'], 'df': ['60'], 'he': ['100']},
                    'LI': {'wh': ['1001']},
...
'''
    ret = {'1229': {'CH': {'at': ['60'], 'df': ['60'], 'he': ['100']},
                    'LI': {'wh': ['2437']},
                    'firstline': ['1229 char 0'],
                    'il': ['78999', '1', '62999', '1', '16', '83', '10', '4'],
                    'na': ['Dan']},
           '1238': {'CH': {'at': ['60'], 'df': ['60'], 'he': ['100']},
                    'LI': {'hl': ['8140'], 'wh': ['5614']},
           ...
           '2219': {'LI': {'hl': ['2437'], 'wh': ['12399']},
                    'SL': {'ca': ['25000'], 'da': ['5'], 'de': ['10']},
                    'firstline': ['2219 ship roundship'],
                    'na': ['Tub 19']},
           '2437': {'CH': {'at': ['60'], 'df': ['60'], 'he': ['100']},
                    'LI': {'hl': ['1229'], 'wh': ['2219']},
